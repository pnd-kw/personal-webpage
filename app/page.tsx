          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 items-center min-h-full">
              ...
              <div className="pb-12">
                <p>
                  Hello! My name is{" "}
                  <span className="font-bold text-sky-700">Krisna</span>,
                  i&apos;m a passionate Flutter Developer with a knack for
                  crafting captivating mobile applications. My journey in coding
                  began with a fascination for creating seamless user
                  experiences. Proficient in Dart and adept at leveraging
                  Flutter&apos;s versatility, I thrive on turning ideas into
                  polished, functional, and aesthetically pleasing apps. My
                  focus lies in building scalable solutions and embracing
                  innovative approaches to ensure delightful user interactions.
                  Let&apos;s create something remarkable together in the world
